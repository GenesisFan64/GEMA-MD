...
; ----------------------------------------------------------------
		...
		dc.b "(C)GF64 2020.DEC"					; "(C)[company] [year].[month]"
		dc.b "GEMA pero que se parece a GEMS                  " ; Your game title in your country
		dc.b "GEMA Sound Engine tester                        "	; Your game title outside of your country
